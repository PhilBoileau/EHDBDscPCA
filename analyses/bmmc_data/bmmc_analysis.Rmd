...
ggsave(
  filename = here("manuscript", "figures", "aml027_cv_results.png"),
  units = "mm",
  width = 178,
  height = 60,
  dpi = 320,
...
```{r save_aml_027_data_plot}
ggsave(
  filename = here("manuscript","figures", "aml027_results.png"),
  width = 178,
  height = 150,
  units = "mm",
  dpi = 350,
...
p1 <- load_diff_df %>%
  ...
  xlab("Genes") +
  ylab("Standardized Abs. Loadings") +
...
ggsave(
  filename = here("manuscript", "figures", "aml035_cv_results.png"),
  units = "mm",
  width = 178,
  height = 60,
  dpi = 320,
...
ggsave(
  filename = here("manuscript","figures", "aml035_results.png"),
  width = 178,
  height = 160,
  units = "mm",
  dpi = 350,
...
# plot the results
rt_plot <- ggplot(summary(rt_analysis), aes(x = expr, y = median)) +
  geom_point() +
  scale_y_log10() +
